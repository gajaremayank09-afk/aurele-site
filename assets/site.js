/* AURÈLE shared site script — cart, category nav, media helpers.
   ...
   DEVELOPER NOTE — adding a new page:
   1. Include this file: <script src="/assets/site.js"></script>
   2. Include theme.js right after it: <script src="/assets/theme.js"></script>
   3. Call initCartUI() once your page's own content has rendered — it injects
      the cart drawer markup automatically, so you don't need to repeat that
      HTML on every page.
   4. If your page loads products.json/categories.json, set window.PRODUCTS
      and window.CATEGORIES after loading — other shared functions (mediaHTML,
      categoryName, the cart) all read from those two globals. */
  ...
  wrap.innerHTML = `
    ...
    <div class="drawer" id="drawer">
      <div class="drawer-head">
        ...
        <button class="close-btn" onclick="closeCart()" aria-label="Close cart">&times;</button>
      </div>
